...
struct TokenKingWidgetView: View {
    ...
    var body: some View {
        // No background/panel drawn here: the system owns the widget background
        // on the macOS desktop (see WidgetDesignToken note). Content sits directly
        // on the system-provided material.
        innerContent
    }
